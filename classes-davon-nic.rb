...
#       folding = Task.new 'fold the clothes'
#       trash = Task.new 'take the trash out'
...
# As a developer, I can create three instances (objects) of class 
...
#     end
# end
#         blue = ColorPalette.new('indigo','Teal','babyblue')
#         green = ColorPalette.new('armygreen','turtlegreen', 'seafoam')
#         red = ColorPalette.new('scarlet','marron','rose')
# p blue
...
#     end
# def all_colors
#     "I use #{@color1},#{@color2},#{@color3} for a pallette. "
#     end
# end
#     blue = ColorPalette.new('indigo','Teal','babyblue')
#     green = ColorPalette.new('armygreen','turtlegreen', 'seafoam')
