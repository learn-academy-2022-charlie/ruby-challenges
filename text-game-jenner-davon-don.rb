...
# l_____  ll   __l  |  l/ __ <   |  |  /  /_l  l_/ ___ll__  l   / __ |/ __ l /     <   |  |
...
def week_one
    ...
    choice = gets.chomp.to_i
    if choice == 1
        make_choice("How are you enjoying class?","1 ) I love it!", "2 ) It's okay", "3 ) It's pretty difficult.")
    elsif choice == 2
        make_choice("How are you enjoying class?","1 ) I love it!", "2 ) It's okay", "3 ) It's pretty difficult.")
    elsif choice == 3
        make_choice("Reading the syllabus you feel that..", "1 ) There is a pattern.", "2 ) It is all pretty interesting material.", "3 ) You're don't understand anything.")
    end
    ...
    choice = gets.chomp.to_i
    if choice == 1
        make_choice("How are you enjoying class?","1 ) How did you become an instrucor?", "2 ) It's okay", "3 ) It's pretty difficult.")
    elsif choice == 2
        make_choice("How are you enjoying class?","1 ) I love it!", "2 ) It's okay", "3 ) It's pretty difficult.")
    elsif choice == 3
...
def week_two
    ...
    choice = gets.chomp.to_i
    if choice == 1
        make_choice("How are you keeping up with class?","1 ) I feel like there is a deeper meaning", "2 ) I'm still doing okay", "3 ) I have no idea whats going on")
    elsif choice == 2
    ...
    if choice == 1
        ...
        make_choice("As you are stretching..","1 ) You meditate and you begin hearing the core values in your heard", "2 ) You're getting a good stretch.", "3 ) You feel stressed and walk out.")
    elsif choice == 3
...
def welcome_onboard
    puts "Hello! Welome to Study Academy!".each_char {|c| putc c ; sleep 0.01; $stdout.flush }
    puts "What is your name?".each_char {|c| putc c ; sleep 0.01; $stdout.flush }
    player = gets.chomp
    puts "Nice to meet you #{player}! We are your instructors Chaustin and Arlene.".each_char {|c| putc c ; sleep 0.01; $stdout.flush }
    ...
    puts "We value your time here at STUDY."
    puts "Our core values are: Growth, Loyalty, and Teamwork."
    puts "We are looking forward to having you join us."
    system("clear")
end
...
def check_total_choices_week_two
    if $total_choices == 0
        ...
        puts "You join the organization"
    elsif $total_choices < 0
