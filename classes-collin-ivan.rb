...
#     end
#     def chore_status
#         if @chore_status == false
#             "you have not done #{@title}"
#         else
#             "you get a beer for doing #{@title}"
#         end
#     end
# end
# dishes = Task.new 'dishes'
# # dishes.get_chore_title 
# dishes.set_chore_status
# dishes.chore_status
# p dishes

# gym = Task.new 'chest day'
# gym.chore_status
# p gym

# cooking = Task.new 'fish'
# cooking.set_chore_status
# cooking.chore_status
# p cooking
