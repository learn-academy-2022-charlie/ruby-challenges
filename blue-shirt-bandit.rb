...
user = gets.chomp 
"#{user}, welcome blah blah do you do this1? or this2?".each_char {|c| putc c; sleep 0.1  }
user_choice = gets.chop

def act_one(input) 
   if(input == "this1")
    option_1= 'you chose option 1'
    option_1.each_char {|c| putc c; sleep 0.1  }
   elsif(input == "this2")
    'you chose option 2'
   else
