...
my_phone = {
    ...
    bbq_spot: 'nearest bbq restaurant',
    spa_app: 'nearest spa'    
}
        # p my_phone
...
my_phone.delete(:bbq_spot)
my_phone.delete(:hair_salon)
 #p my_phone

#Output:{:settings=>"How my phone works", :spa_app=>"I am tired", :locate_phone=>"Where is my phone"}

# As a developer, I can use an enumerable method to return information about all of my_phone's applications.


my_phone.map do |key, value|
       p "The #{key} app is made to locate #{value}."
     end
