...
# - As a developer, I can update the status of each instance of class Task when the task has been completed.
    ...
    #             @status = 'completed'
    #             p "The #{@title.downcase} are completed!"
    #        else
    #            p "The #{@title.downcase} are already completed!"
    #        end
    #     end
    # end
    ...
    # dishes.completed() # -> complete 'The dishes are completed!' 
    # laundry.completed()
    # mopping.completed()
    # dishes.completed() # -> complete -> 'The dishes are already completed!
